...
$(".populationBtn").on("click", function (e) {
  $(".text").text("10 Most populated countriesin the world");
  $(".dataSort").html("");
  let populationData = countries_data.sort(
    (a, b) => b.population - a.population
  );

  let first10 = populationData.slice(0, 9);
...
$(".area").on("click", function (e) {
  $(".text").text("10 Most big area in the world");
  $(".dataSort").html("");
